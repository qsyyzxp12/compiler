...
extern int g_anyErrorOccur;
 ...
 static inline AST_NODE* makeSibling(AST_NODE *a, AST_NODE *b)//sibling is brothersibsibsib
{ 
...
term		: term mul_op factor
		  ...
		  /* $$ = makeTermNode = (BINARY_OPERATION, BINARY_OP_MUL)*/
                }
            | factor
                {
                    /*TODO*/
